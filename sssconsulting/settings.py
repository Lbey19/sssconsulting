"""
Django settings for sssconsulting project.
...
SECRET_KEY = 'django-insecure-5i_%h@9!#+esf-pn=+*x$q+z@%3sr3mbds9x#9%2&9byk6%xzk'
...
ROOT_URLCONF = 'sssconsulting.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / 'pages/templates',  # Chemin absolu
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_REDIRECT_URL = 'home'  # ou tout autre nom d'URL
